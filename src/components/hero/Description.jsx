  ...
  useEffect(() => {
    const develop = new Typed(devRef.current, {
      strings: [
        ...
        '&nbsp;<span class="font-bold text-[#F05340] drop-shadow-sm" style="filter: drop-shadow(0 0 20px  rgb(240 83 64 / 0.35)) drop-shadow(0 0 20px rgb(240 83 64 / 0.2))">Laravel</span> developer',
